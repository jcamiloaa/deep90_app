...
class AssistantConfig(models.Model):
    ...
    language_style = models.CharField(_("Estilo de lenguaje"), max_length=50, default='normal')
    experience_level = models.CharField(_("Nivel de experiencia"), max_length=50, default='media')
